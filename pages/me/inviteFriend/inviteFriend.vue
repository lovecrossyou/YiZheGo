	...
	<view class="invite_friend_wrapper">
		<view class="banner">
			<view class="banner_item">
				...
				<view class="intro">
					<span class="count">{{ userProfitInfo.userFriendAmount }}</span>
					人
				</view>
			</view>
			<view class="banner_item">
				...
				<view class="intro">
					<span class="count">{{ userProfitInfo.inviteProfitXtbAmount }}</span>
					喜币
				</view>
			</view>
			<view class="banner_item">
				...
				<view class="intro">
					<span class="count">{{ userProfitInfo.shareSellProfitRmbAmount }}</span>
					元
				</view>
			</view>
		</view>
		...
		<view class="footer">
			<view class="foot_tit"><image :src="yaoqing_icon_jinagli"></image></view>
